...
# Contact
#tipos: email, phone, mobile, zap
CONTACT = [
    {'type': 'email', 'contact': 'email@email.com'},
    {'type': 'phone', 'contact': '559399999999'},
    {'type': 'mobile', 'contact': '5593999999999'},
    {'type': 'zap', 'contact': '5593999999999'}
]
...
SCHEDULE = [
    {'day': 'terça-feira', 'time': '17h - 2h30'},
    {'day': 'quarta-feira', 'time': '17h - 2h30'},
    {'day': 'quinta-feira', 'time': '17h - 2h'},
    {'day': 'sexta-feira', 'time': '17h - 2h30'},
    {'day': 'sábado', 'time': '17h - 2h30'},
    {'day': 'domingo', 'time': '17h - 2h30'},
    {'day': 'segunda-feira', 'time': '17h - 2h'}
]
